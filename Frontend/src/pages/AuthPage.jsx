    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-50 text-black">
      <div className="bg-white p-8 rounded-xl shadow-md w-96 border border-gray-100">
        ...
        <div className="flex justify-center mb-6">
          <div className="h-16 w-16 rounded-full bg-[#FFE6EA] flex items-center justify-center text-[#FF7C8C]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FFB6C1] focus:border-transparent" 
                    required 
                  />
                </div>
          ...
          <button 
            type="submit" 
            className="w-full bg-[#FFB6C1] hover:bg-[#fba8b5] text-black p-2 rounded-lg font-medium transition-colors mt-4"
          >
        ...
        <p className="text-center mt-6 text-gray-600 text-sm">
          ...
          <span 
            ...
            className="text-[#FF7C8C] cursor-pointer font-medium hover:underline"
          >
