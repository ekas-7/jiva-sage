...
const Appointments = ({ darkMode }) => {
  ...
  return (
    <Card className={`h-full overflow-hidden ${darkMode ? "bg-gray-900 border-gray-800" : "bg-white border-gray-100"}`}>
      <CardHeader className={`p-6 ${darkMode ? "border-gray-800" : "border-gray-100"} border-b`}>
        <div className="flex justify-between items-center">
          ...
          <Button className="bg-[#ffdde2] hover:bg-[#ffcbd3] text-black font-medium transition-colors border-0">
            Schedule Now
          </Button>
        </div>
      </CardHeader>
        ...
        {isPast ? (
          ...
          appointment.isOnline && (
            <Button
              variant="outline"
              size="sm"
              className={`${darkMode ? "border-gray-700 text-gray-300 hover:bg-gray-800" : ""} border-[#ffdde2] hover:border-[#ffcbd3] hover:bg-[#ffdde2] hover:bg-opacity-10`}
            >
              Join Meeting
              <ExternalLink size={14} className="ml-2" />
            </Button>
